			...
			?>
				<div class="uael-retina-image-set">
					<div class="uael-retina-image-container">
						<img class="uael-retina-img <?php echo $class_animation; ?>" src="<?php echo $image_url; ?>" alt="<?php echo Control_Media::get_image_alt( $settings['retina_image'] ); ?>" srcset="<?php echo $image_url . ' 1x' . ',' . $retina_image_url . ' 2x'; ?>"/>
					</div>
				</div>
			<?php if ( $link ) : ?>
					</a>
